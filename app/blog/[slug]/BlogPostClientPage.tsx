...
import { Calendar, Clock, ArrowLeft, Share2, Heart, Eye, Award, BookOpen } from "lucide-react"
...
const relatedPosts = [
  {
    ...
    title: "Nutrition for Muscle Building: The Complete Guide",
    image: "/placeholder.svg?height=200&width=300&text=Nutrition+Guide",
    category: "Nutrition",
  ...
  },
  {
    ...
    title: "Swimming: The Ultimate Full-Body Workout",
    image: "/placeholder.svg?height=200&width=300&text=Swimming+Guide",
    category: "Swimming",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=300&text=Yoga+Guide",
    category: "Yoga",
    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <div className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <Link href="/blog">
            <Button variant="ghost" className="hover:bg-orange-50 hover:text-orange-500">
        ...
        <div className="container mx-auto px-4">
          <ScrollAnimation>
            <div className="max-w-4xl mx-auto">
              {/* Category Badge */}
              <div className="mb-6">
                <Badge className="bg-orange-500 text-white text-sm px-3 py-1">{post.category}</Badge>
              </div>

              {/* Title */}
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-black">{post.title}</h1>
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="hover:bg-orange-50 hover:text-orange-500 hover:border-orange-500 bg-transparent"
                >
            ...
            <div className="grid lg:grid-cols-4 gap-12">
              ...
              <ScrollAnimation delay={200}>
                <div className="lg:col-span-3">
                  <div
                    className="prose prose-lg max-w-none prose-headings:text-black prose-headings:font-bold prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-orange-500 prose-a:no-underline hover:prose-a:underline prose-strong:text-black prose-ul:text-gray-700 prose-ol:text-gray-700"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {post.tags.map((tag) => (
                        <Badge
                          key={tag}
                          variant="outline"
                          className="hover:bg-orange-50 hover:text-orange-500 hover:border-orange-500"
                        >
                          {tag}
                        </Badge>
                      ))}
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {relatedPosts.map((relatedPost, index) => (
                  <ScrollAnimation key={relatedPost.id} delay={index * 100}>
                    <Card className="h-full hover:shadow-xl transition-all duration-300 group">
                      ...
                      <CardContent className="p-6">
                        ...
                        <Link href={`/blog/${relatedPost.slug}`}>
                          <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white">Read Article</Button>
                        </Link>
                      </CardContent>
                    </Card>
                  </ScrollAnimation>
          ...
          <ScrollAnimation>
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-gray-300 mb-8">
                Put these insights into action with personalized training and expert guidance at Aura Fitness Studio.
              </p>
