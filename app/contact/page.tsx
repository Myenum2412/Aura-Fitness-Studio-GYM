...
export const metadata: Metadata = {
  ...
  keywords:
    "contact aura fitness, gym contact, fitness consultation, schedule tour, gym membership",
  openGraph: {
    title: "Contact Us - Aura Fitness Studio",
    description:
      "Contact Aura Fitness Studio for membership information, tours, and fitness consultations.",
    type: "website",
  },
};
...
const locationInfo = [
  ...
  },
  {
    icon: Clock,
    title: "Hours",
    details: ["Mon - Sat 5:30 am – 9:30 pm", "Sun 7 : 00 am - 11 : 00 pm"],
  },
  {
    icon: Phone,
    title: "Phone",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <ScrollAnimation>
              ...
              >
                Ready to start your fitness journey? We're here to help you
                every step of the way. Contact us today to learn more about our
                services and schedule your free consultation.
              </p>
            </ScrollAnimation>
          </div>
        </div>
            ...
            <ScrollAnimation>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Choose the method that works best for you. Our team is ready
                  to assist with any questions or help you get started.
                </p>
              </div>
            </ScrollAnimation>
                  ...
                  return (
                    <ScrollAnimation key={index} delay={index * 100}>
                      <Card className="h-full hover-lift bg-white/5 border-gray-800 hover:border-accent-orange/50 transition-all duration-300 group backdrop-blur-sm text-center">
                        <CardHeader>
                          <div
                            className={`mx-auto p-4 ${method.bgColor} rounded-xl mb-4 w-fit`}
                          >
                            <IconComponent
                        ...
                        <CardContent>
                          ...
                          <a
                            href={method.href}
                            className="btn-secondary w-full text-sm block"
                          >
                            {method.action}
                          </a>
                        </CardContent>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <ScrollAnimation>
                <div>
                  ...
                  <p className="text-gray-300 mb-8">
                    ...
                    hours. Let us know how we can help you achieve your fitness
                    goals.
                  </p>
                  <ContactForm />
                </div>
              ...
              <ScrollAnimation delay={300}>
                <div>
                  ...
                  <p className="text-gray-300 mb-8">
                    Located in the heart of Salem, our premium facility is
                  ...
                  <div className="space-y-6">
                    {locationInfo.map((info, index) => {
                      ...
                      return (
                        <Card
                          key={index}
                          className="bg-white/5 border-gray-800 backdrop-blur-sm"
                        >
                    ...
                    >
                      <div className="absolute inset-0 bg-gray-800 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-gray-400 text-sm">
                            Vasagasalai St, Ponnammapet, Salem
                          </p>
                          <div className="mt-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <ScrollAnimation>
              ...
              <p className="text-xl mb-8 opacity-90">
                Schedule your free consultation and facility tour today.
                Experience the Aura Fitness difference firsthand.
              </p>
