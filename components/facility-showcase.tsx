...
const facilities = [
  ...
  {
    title: "Mini Olympic Swimming Pool",
    description:
      "25-meter, 6-lane pool with advanced filtration system and temperature control, perfect for lap swimming and aqua fitness.",
    image: "/Images/Home/OlympicSwimmingPool.jpeg?height=400&width=600&text=Olympic+Swimming+Pool",
    icon: Waves,
    features: ["6 swimming lanes", "Diving area", "Pool deck seating"],
    size: "25m x 13.5m",
  ...
  },
  {
    ...
    icon: Users,
    features: ["Mirrored walls", "Premium sound", "Equipment storage"],
  ...
  },
  {
    ...
    icon: Heart,
    features: [ "Meditation space", "Recovery equipment", "Consultation rooms"],
    size: "800 sq ft",
  ...
  },
  {
    ...
    icon: Dumbbell,
    features: ["City views", "Latest equipment"],
    size: "2,500 sq ft",
