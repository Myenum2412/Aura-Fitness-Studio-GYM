...
const services = [
  {
    ...
    features: ["24/7 Access", "Latest Equipment", "Spacious Layout", "Climate Controlled"],
    price: "$49",
    period: "/month",
    popular: false,
  ...
  },
  {
    ...
    title: "Swimming Pool",
    description:
      "Olympic-size swimming pool with dedicated lanes for lap swimming, aqua fitness classes, and recreational swimming.",
    image: "/Images/Services/Swimmingpool.jpeg?height=300&width=400&text=Olympic+Swimming+Pool",
    features: ["Olympic Size Pool", "Heated Water", "Aqua Fitness Classes", "Swimming Lessons"],
    price: "$69",
    period: "/month",
    popular: true,
    color: "text-accent-orange",
  ...
  },
  {
    ...
    color: "text-accent-orange",
    bgColor: "bg-accent-orange/10",
    details: "Over 100 classes per week with options for beginners to advanced fitness enthusiasts.",
  },
]
